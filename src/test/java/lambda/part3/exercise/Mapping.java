...
public class Mapping {
    ...
    public static List<JobHistoryEntry> addExperience(List<JobHistoryEntry> list, final int yearsToAdd) {
        return new MapHelper<>(list)
                .map(t -> t.withDuration(t.getDuration() + yearsToAdd))
                .getList();
    }

    public static List<JobHistoryEntry> toUpperCase(List<JobHistoryEntry> list) {
        return new MapHelper<>(list)
                .map(t -> t.getPosition().equals("qa") ? t.withPosition(t.getPosition().toUpperCase()) : t)
                .getList();
    ...
    public void mapping() {
        ...
        final List<Employee> mappedEmployees =
                new MapHelper<>(employees)
                        ...
                        .map(e -> e.withJobHistory(addExperience(e.getJobHistory(), 1)))
