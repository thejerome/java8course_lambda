...
public class Mapping {
    ...
    private static List<JobHistoryEntry> replaceQA(List<JobHistoryEntry> jobHistoryEntries) {
        return new MapHelper<JobHistoryEntry>(jobHistoryEntries)
                .map(j -> j.getPosition().contentEquals("qa") ?
                        j.withPosition("QA") : j.withPosition(j.getPosition()))
                .getList();
    }
