...
public class ArrowNotationExercise {
  ...
  public void compareAges() {
    ...
    BiPredicate<Person, Person> compareAges = ((person, person2) -> person.getAge() == person2
        .getAge());
  ...
  public BiFunction<Person, Person, Integer> ageOfPersonWithTheLongestFullName(
    ...
    return (person, person2) -> function.apply(person).length() > function.apply(person2).length()
