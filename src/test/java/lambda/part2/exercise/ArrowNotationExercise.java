...
public class ArrowNotationExercise {
    ...
    private static BiFunction<Person, Person, Integer> ageOfPersonWithTheLongestFullName(Function<Person, String> f) {
        return (person, person2) ->
                f.apply(person).length() > f.apply(person2).length() ? person.getAge() : person2.getAge();
