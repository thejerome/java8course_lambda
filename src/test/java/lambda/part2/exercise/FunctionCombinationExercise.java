...
public class FunctionCombinationExercise {
  ...
  public void personHasNotEmptyLastNameAndFirstName0() {
    // Person -> boolean
    final Predicate<Person> validate = p -> !p.getFirstName()
  ...
  public void personHasNotEmptyLastNameAndFirstName1() {
    final Predicate<Person> hasEmptyFirstName = p -> p.getFirstName()
                                                      .isEmpty();
    final Predicate<Person> hasEmptyLastName = p -> p.getLastName()
                                                     .isEmpty();
  ...
  public void personHasNotEmptyLastNameAndFirstName3() {
    ...
    final Predicate<Person> validateFirstName = negate(
        hasEmptyFirstName); // TODO use Predicate::negate
    final Predicate<Person> validateLastName = negate(
        hasEmptyLastName); // TODO use Predicate::negate

    final Predicate<Person> validate = and(validateFirstName,
        validateLastName); // TODO use Predicate::and
