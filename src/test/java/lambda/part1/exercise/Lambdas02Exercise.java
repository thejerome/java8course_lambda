...
public class Lambdas02Exercise {
    ...
    public void sortPersonsByAge() {
        ...
        Arrays.sort(persons, (o1 , o2) -> (o1.getAge() > o2.getAge()) ? 1 : (o1.getAge() < o2.getAge() ? -1 : 0));
    ...
    public void findFirstWithAge30() {
        ...
        Optional<Person> personOptional = FluentIterable.from(persons).firstMatch(p -> {
            if(p != null && p.getAge() == 30)
            return true;
            else return false;
        });
