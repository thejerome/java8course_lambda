...
public class Lambdas03Exercise {
    ...
    public void generic0() {
        final GenericProduct<Integer> prod =  // Use anonymous class
    ...
    public void generic1() {
        final GenericProduct<Integer> prod =  // Use statement lambda
                (Integer a, int i) -> {
                    return a * i;
                };
        assertEquals(prod.prod(3, 2), Integer.valueOf(6));
    ...
    public void generic2() {
        final GenericProduct<Integer> prod =  // Use expression lambda
                (a, i) -> a * i;
        assertEquals(prod.prod(3, 2), Integer.valueOf(6));
    }
    ...
    @Test
    public void strSum() {
        final GenericProduct<String> prod =  // use stringProd;
                (a, i) -> stringProd(a, i);
    ...
    @Test
    public void strSum2() {
        final GenericProduct<String> prod =  // use stringSumWithDelimeter;
                (a, i) -> stringSumWithDelimeter(a, i);
